...
toc: yes
featuredImage: /images/Big_Picture_Food_Waste.jpeg
featuredVideo: null
draft: no
---
...
* Clarity of Explanation
  * You should have a clear thesis/goal for this page. What are you trying to show? Make sure that you explain your analysis in detail but don't go into top much mathematics or statistics. The audience for this page is the general public (to the extent possible).
  ...
  Thesis + analysis: Globally, countries with a high GDP tended to waste more food than they produce. However, using linear regressions GDP does not accurately explain food waste. Additionally, we noticed countries that are experiencing economic turmoil also experience an increase in food waste. """confirm this is true with other countries"""
  Locally, we are the largest culprit of this food waste. The United States has the most commodities that have above 40% loss, this is a significant amount compared to many other countries. Interestingly, in the U.S., juices take the lead for products with the the highest amount of waste. """include something about juice production""". We observed the highest amount of food loss in the U.S. during the 2008 recession. This is counter intuitive and concerning considering that food becomes more challenging to afford during these times. """also check food production during these times to perhaps draw a connection to food availability """. 
  
  All over the world, we need to focus on reducing food waste. Although the global trend shows an overall reduction in food waste since 1970, but many countries including the U.S. have a long way to go to solve this epidemic. 
