...
Wasteplot <- Fooddata %>% ggplot(aes(x = year, y = mean_loss)) + geom_smooth(size = .5, se = TRUE) + labs(title = "Global amount of food waste since 1966", x = "Year", y = "Percent of Food Wasted")
Wasteplot
```
While we do not have a clear answer to why this is occurring from the data, we do theorize that it is likely due to increased efficiency of the agricultural sector in terms of production and cultivation that has allowed for improvement on loss.
