...
```{r 2, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
FoodLossandWasteAllClean %>%
  select(country,commodity, mean_loss_percentage)%>%
...
```{r 3, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
FoodLossandWasteAllClean %>%
...
```{r 4, echo=FALSE, message=FALSE, warning=FALSE, paged.print=TRUE}
FoodLossandWasteAllClean %>%
  select(year,country,commodity, mean_loss_percentage)%>%
  filter(country == 'United States of America') %>%
  group_by(commodity) %>%
